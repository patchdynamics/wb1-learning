...
do
	...
	do
		...
		python runSimulation.py -e $epsilon --dams 1 --year 2010 -a Lookup #> /dev/null
		python runSimulation.py -e $epsilon --dams 1 --year 2011 -a Lookup #> /dev/null
		python runSimulation.py -e $epsilon --dams 1 --year 2012 -a Lookup #> /dev/null
		python runSimulation.py -e $epsilon --dams 1 --year 2013 -a Lookup #> /dev/null
		python runSimulation.py -e $epsilon --dams 1 --year 2014 -a Lookup #> /dev/null
		python runSimulation.py -e $epsilon --dams 1 --year 2015 -a Lookup #> /dev/null
	done
done
